...
public final class McefBackend implements IBrowserBackend {
    ...
    public IBrowser create(String url, int width, int height) {
        ...
        // 拦截“开新窗口”：把它拉回当前标签加载。不拦的话，target=_blank 的链接
        // 点了没反应——CEF 里 window.open / target=_blank 走的是 onBeforePopup，
        // 默认实现直接拒绝且不报错，页面看起来就是“点了没反应”
